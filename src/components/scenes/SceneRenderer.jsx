...
// ── Ship of Stars scenes ────────────────────────

function SerbiaNightScene() {
  return (
    <>
      <Stars count={60} />
...
function SvetlostShipScene({ accent }) {
  return (
    <>
      <Stars count={40} />
      <svg viewBox="0 0 400 200" style={{ position: 'absolute', bottom: 0, width: '100%', height: '100%' }}>
...
function SolarSystemScene({ accent }) {
  return (
    <>
      <Stars count={30} />
      <svg viewBox="0 0 400 200" style={{ position: 'absolute', bottom: 0, width: '100%', height: '100%' }}>
...
function SaturnJupiterScene({ accent }) {
  return (
    <>
      <Stars count={35} />
      <svg viewBox="0 0 400 200" style={{ position: 'absolute', bottom: 0, width: '100%', height: '100%' }}>
...
function StarNurseryScene({ accent }) {
  return (
    <>
      <Stars count={30} />
      <svg viewBox="0 0 400 200" style={{ position: 'absolute', top: 0, width: '100%', height: '100%' }}>
...
function DeepSpaceScene({ accent }) {
  return (
    <>
      <Stars count={80} />
      <svg viewBox="0 0 400 200" style={{ position: 'absolute', top: 0, width: '100%', height: '100%' }}>
...
// ── When Samantha Began scenes ──────────────────

function BedtimeQuestionScene({ accent }) {
  return (
    <>
      <Stars count={30} />
...
function StoryBeginsScene({ accent }) {
  return (
    <>
      <Stars count={20} />
      <svg viewBox="0 0 400 200" style={{ position: 'absolute', bottom: 0, width: '100%', height: '100%' }}>
...
function TinyBeginningsScene({ accent }) {
  return (
    <>
      <Stars count={25} />
      <svg viewBox="0 0 400 200" style={{ position: 'absolute', bottom: 0, width: '100%', height: '100%' }}>
...
function MamasHeartScene({ accent }) {
  return (
    <>
      <Stars count={15} />
      <svg viewBox="0 0 400 200" style={{ position: 'absolute', bottom: 0, width: '100%', height: '100%' }}>
...
function DadyWhispersScene({ accent }) {
  return (
    <>
      <Stars count={20} />
      <svg viewBox="0 0 400 200" style={{ position: 'absolute', bottom: 0, width: '100%', height: '100%' }}>
...
function HeartbeatScene({ accent }) {
  return (
    <>
      <Stars count={15} />
      <svg viewBox="0 0 400 200" style={{ position: 'absolute', bottom: 0, width: '100%', height: '100%' }}>
...
function ArrivalDayScene({ accent }) {
  return (
    <>
      <Stars count={20} />
      <svg viewBox="0 0 400 200" style={{ position: 'absolute', bottom: 0, width: '100%', height: '100%' }}>
...
function FirstHoldScene({ accent }) {
  return (
    <>
      <Stars count={20} />
      <svg viewBox="0 0 400 200" style={{ position: 'absolute', bottom: 0, width: '100%', height: '100%' }}>
...
function BrightWorldScene({ accent }) {
  return (
    <>
      <Stars count={50} />
